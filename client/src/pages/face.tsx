...
export default function Face() {
  ...
  const { data: products, isLoading, error } = useQuery({
    queryKey: ['/api/products/category/face'],
  });
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-light leading-tight mb-3">
            Face <span className="font-medium">Care</span>
          </h1>
          <p className="text-gray-600 max-w-2xl mx-auto">
            Discover natural skincare products designed to harmonize with your dosha type and promote radiant, healthy skin.
          </p>
        </div>
              ...
              <Card key={product.id} className="product-card bg-white rounded-2xl overflow-hidden shadow-md transition-all duration-300 hover:shadow-xl">
                ...
                <CardContent className="p-5">
                  <div className="flex justify-between items-start mb-2">
                    <div>
                      <span className="text-sm text-gray-500">Face</span>
