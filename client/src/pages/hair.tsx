...
export default function Hair() {
  ...
  const { data: products, isLoading, error } = useQuery({
    queryKey: ['/api/products/category/hair'],
  });
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-light leading-tight mb-3">
            Hair <span className="font-medium">Care</span>
          </h1>
          <p className="text-gray-600 max-w-2xl mx-auto">
            Revitalize your hair with our range of natural, dosha-specific products designed to strengthen from root to tip.
          </p>
        </div>
