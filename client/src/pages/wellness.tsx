...
export default function Wellness() {
  ...
  const { data: products, isLoading, error } = useQuery({
    queryKey: ['/api/products/category/wellness'],
  });
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-light leading-tight mb-3">
            Wellness <span className="font-medium">Products</span>
          </h1>
          <p className="text-gray-600 max-w-2xl mx-auto">
            Balance your inner ecosystem with our range of supplements, teas, and wellness products designed according to Ayurvedic principles.
          </p>
        </div>
